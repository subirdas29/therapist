    ...
    <div>
      <div className='flex px-[30px] py-[24px] justify-between border-b-2 border-b-[#E7E7E7] bg-[#FFFFFF]'>
        ...
        <div className='flex md:hidden'>
          ...
          <img className='w-6 h-6 ml-3 cursor-pointer' src={menu} alt="" onClick={toggleModal} />
        </div>
      </div>
      {isModalOpen && <DashboardModal user={user} handleLogOut={handleLogOut} toggleModal={toggleModal} />}
    </div>
  );
};
