              ...
              <div className='absolute bottom-0 min-w-full justify-center items-center'>
                ...
                <div className='pt-2 pb-6 w  bg-white rounded-t-badge'>
                  <div className='mt-[25px] mb-[30px]'>
                    ...
                    <p className='text-[14px] md:text-[16px] md:text-left text-center text-[#5C635A]  md:leading-[28px] mt-4 hidden md:block'>Welcome Back! By click the sign up button, you`re agree to Zenitood Terms and Service and acknowledge the <br /><span className="cursor-pointer underline text-[#4285F3]">Privacy and Policy</span></p>
                  </div>
                    ...
                    <form onSubmit={handleSignup}>
                      <div >
                        ...
                        <div className='mb-[14px]'>
                          ...
                          <div className='relative'>
                            <input type={showPassword ? "text" : "password"} name="password" placeholder='Enter your password' className='w-full px-4 py-2 md:py-3 rounded-lg border border-1 placeholder:text-[#5C635A] focus:placeholder:opacity-0' />
                            <div className='absolute top-1/3 right-0 mr-2 text-[#5C635A] cursor-pointer' onClick={() => setShowPassword(!showPassword)}>
                        ...
                        <div className='flex justify-between mb-[28px] md:mb-[42px]'>
                          <div className='flex items-center'>
                            <input type="checkbox" className='w-4 h-4' checked={isChecked} onChange={() => setIsChecked(!isChecked)} />
                ...
                <div className='bg-white rounded-lg'>
                  <form onSubmit={handleSignup}>
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='relative'>
                        <input type={showPassword ? "text" : "password"} name="password" className='w-full px-4 py-2 border rounded-lg' placeholder='Enter your password' />
                        <div className='absolute top-2 right-3 text-gray-500 cursor-pointer' onClick={() => setShowPassword(!showPassword)}>
                          {showPassword ? <FaRegEye /> : <FaRegEyeSlash />}
                        </div>
                      </div>
                    </div>
